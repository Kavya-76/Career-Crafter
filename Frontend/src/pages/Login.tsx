...
const Login = () => {
  ...
  const accentColor = isEmployer ? 'hsl(var(--role-employer))' : 'hsl(var(--role-employee))';
  const accentHoverColor = isEmployer ? 'hsl(var(--role-employer-hover))' : 'hsl(var(--role-employee-hover))';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      toast.success(
        "Login successful!",{
        description: `Welcome back, ${isEmployer ? 'employer' : 'job seeker'}!`,
      });
